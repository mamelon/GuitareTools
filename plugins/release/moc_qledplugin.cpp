...
**
** Created: Sat May 5 10:48:20 2012
...
static const char qt_meta_stringdata_QLedPlugin[] = {
    "QLedPlugin\0"
};
...
const QMetaObjectExtraData QLedPlugin::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject QLedPlugin::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_QLedPlugin,
      qt_meta_data_QLedPlugin, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &QLedPlugin::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_QLedPlugin))
